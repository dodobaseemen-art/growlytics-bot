...
2. Run `src/db/schema.sql` on PostgreSQL for a new database, or run `src/db/migrations/001_message_events_and_analytics_metrics.sql` on an existing database.
